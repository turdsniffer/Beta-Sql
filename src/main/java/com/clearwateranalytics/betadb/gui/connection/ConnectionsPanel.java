...
import com.clearwateranalytics.betadb.gui.dao.DbInfoDAO;
...
public class ConnectionsPanel extends javax.swing.JPanel implements EventListener
{
    ...
    private void initComponents() {
        ...
        btnAddDataSource.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/clearwateranalytics/betadb/gui/icons/connect.png"))); // NOI18N
	...
	{//GEN-HEADEREND:event_btnConnectActionPerformed
		...
		EventManager.getInstance().fireEvent(SQL_CONNECTION_REQUESTED, new ConnectionInfo(dbInfo, dataSourceKey));
	...
	{//GEN-HEADEREND:event_btnScriptActionPerformed
		...
		try
		{
			...
			EventManager.getInstance().fireEvent(SQL_CONNECTION_REQUESTED, new ConnectionInfo(dbInfo, server, script));			
		}
		catch (SQLException ex)
		{
